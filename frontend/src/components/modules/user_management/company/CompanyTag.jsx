...
export default function CompanyTag(
    { companyData, handleUserDelete, handleUserUpdate, handleUserLock, handleUserPasswordUpdate }
) {
    return (
        <div className="w-full h-28 flex place-items-center justify-center shadow-md
            ...
            <div className="flex-1">
                <h1 className="font-bold text-xl">
                    {companyData.name} {companyData.surname}
                </h1>
            ...
            <div className="flex gap-2 text-xl text-center text-white">
                ...
                hover:scale-105 transition
                ${(companyData.isEnabled) ? "bg-valid_green" : "bg-warning_red"}`}>
